...
class UserBooksIndex extends Component {
  ...
  componentDidMount(){
    var books = this.sendRequestToGetBooks(1).then(response => {
      console.log(response.data[2].getData().name , 'bookssssssssss')
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          <tr>
            ...
            <td><span class="text-ellipsis">zzzzzzzzzzz</span></td>
            <td><span class="text-ellipsis">zaaaaaaaaaaaaa</span></td>
            <td>
